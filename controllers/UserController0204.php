...
print_R($_FILES); */
	...
	public function altaFotos($id_inmobiliaria , $id_aviso)
	{
		...
		try{
			...
			{ 
				$ordenFoto = $this->impactarImagen($id_inmobiliaria ,$id_aviso, 'imagen1' , 1 ) ;
				...
				echo "ANDA A LA PUTA"; /*grabar foto por defecto*/
