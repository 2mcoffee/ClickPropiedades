...
/* 		require 'models/LogModel.php';
	...
	public function altaInmobiliaria ()
	{
		...
		{
			$register = $this->model->InsertCustomer($_POST['username'],$_POST['password'] ,$_POST['razonsocial'] , $_POST['cuit'] , $_POST['asesor'] ,  $_POST['codigo'] , $_POST['telefono'] , $_POST['cel'] , $_POST['email'] , $_POST['web'] , $_POST['calle'] , $_POST['altura'] , $_POST['piso'] , $_POST['depto']  ,   $_POST['localidad'] , $alto, $ancho , $id_rol , $habilitada, $tipo_plan ) ;
			if(is_null($register))
