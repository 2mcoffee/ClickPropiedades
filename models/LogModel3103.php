...
class LogModel
{
	...
	public function InsertCustomer($username, $password, $razonsocial, $cuit, $asesor, $region, $telefono, $movil,  $email, $web, $direccion, $altura, $piso, $localidad, $alto, $ancho, $id_rol, $habilitada, $tipo_plan)
	{
		$dir = null ;
